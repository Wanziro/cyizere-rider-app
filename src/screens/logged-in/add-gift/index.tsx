...
const AddGift = ({navigation}: INavigationProp) => {
  ...
  const handleSubmit = () => {
    ...
    normalAlert({
      message:
        'Do you want to save this gift? Please make sure that you have checked each step details',
      hasCancleBtn: true,
      cancelText: 'No',
      okText: 'Yes, save',
  ...
  const handleSave = () => {
    ...
    setIsLoading(true);
    const url = app.BACKEND_URL + '/gifts/';
